# 배터리 업그레이드
"""
Battery 클래스에 upgrade_battery() 메서드를 추가하자. 이 메서드는 배터리 크기를
체크하고, 용량이 85kWh가 아니면 85kWh로 바꿔야 한다. 기본 배터리 크기로 전기자동차를
만들어 get_range()를 한 번 호출하고, 배터리를 업그레이드 한 다음 한 번 더
get_range()를 호출하자. 자동차의 주행 가능 거리가 늘어나야 한다.
"""
...
class Battery():
    ...
    def upgrade_battery(self):
        """배터리 크기를 체크하고, 용량이 85kWh가 아니면 85kWh로 바꾼다."""
